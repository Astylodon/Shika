...
class PageController
{
    ...
    public function __construct(Twig $twig, Session $session, SiteRepository $sites, UserRepository $users)
    {
        $this->twig = $twig;
    ...
    {
        return $this->twig->render($response, "dashboard/keys.html.twig");
    }
}